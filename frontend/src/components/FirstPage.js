...
const FirstPage = () => {
    ...
    return (
        <div
            ...
            style={{ backgroundImage: `url('/images/Landing.jpg')` }} // Path to your dark bluish background image
        >
            {/* Header */}
            <header className="flex items-center justify-between w-full max-w-4xl px-6 md:px-12 py-4 bg-blue-900 bg-opacity-0 shadow-lg rounded-b-lg">
                <img src="./images/nisb-logo.png" alt="NISB" className="w-12 h-12 md:w-16 md:h-16" />
                <h1 className="text-2xl md:text-3xl font-bold text-white tracking-widest">CRYPTOQUEST</h1>
            ...
            <main className="flex-grow flex items-center justify-center px-6 py-10">
                <div className="w-full max-w-lg p-8 md:p-12 bg-blue-900 bg-opacity-25 border border-blue-800 rounded-2xl shadow-xl text-center">
                    <p className="mb-6 text-lg md:text-xl text-white font-medium">
