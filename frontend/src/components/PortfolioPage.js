...
const PortfolioPage = () => {
    ...
    return (
        <div className="p-4">
            ...
            <div>
                <button onClick={() => navigate("/portfolio/project-a")} className="mt-4 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Know My Journey</button>
            </div>
        </div>
    );
};
